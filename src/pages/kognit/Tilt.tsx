...
const steps = ["Pause", "Take a breath", "You're in control", "Let it go"];
...
export const TiltScreen = () => (
  <div className="min-h-full bg-gradient-deep text-primary-foreground relative overflow-hidden">
    ...
    <div className="relative px-6 pt-3 flex items-center justify-between">
      ...
      <span className="text-xs font-semibold opacity-80 tracking-widest">TILT RESET • 2 / 4</span>
      <span className="w-10" />
    </div>
    ...
    <div className="relative mt-12 flex justify-center">
      <div className="relative w-56 h-56 flex items-center justify-center">
        ...
        <span className="relative text-2xl font-bold">Breathe</span>
      </div>
    </div>

    <div className="relative mt-12 px-8 text-center">
      <p className="text-xs uppercase tracking-[0.3em] opacity-70 font-semibold">Step 2</p>
      <h1 className="mt-3 text-4xl font-bold leading-tight">Take a breath</h1>
      <p className="mt-3 text-sm opacity-80 leading-relaxed">
        Inhale for 4. Hold for 7. Exhale for 8.<br />
        The hand is over. Your edge is your calm.
      </p>
    </div>
    ...
    <div className="relative px-6 mt-10">
      <button className="w-full bg-primary-foreground text-foreground font-bold py-4 rounded-2xl flex items-center justify-center gap-2 shadow-glow">
        I'm grounded <ChevronRight size={18} />
      </button>
      <button className="mt-3 w-full text-sm opacity-80 font-medium py-2">I need another minute</button>
    </div>
  </div>
);

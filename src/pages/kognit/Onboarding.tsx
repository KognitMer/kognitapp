        ...
        return (
          <button
            ...
            className={`relative flex flex-col items-center text-center gap-1 p-4 rounded-2xl border transition-all active:scale-95 ${
              selected ? "bg-primary/10 border-primary shadow-glow" : "bg-card border-border"
            }`}
          >
            {selected && (
              <span className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-primary text-primary-foreground flex items-center justify-center animate-in zoom-in duration-200">
        ...
        return (
          <button
            ...
            className={`w-full flex items-center gap-3 p-4 rounded-2xl border transition-all active:scale-95 ${
              selected ? "bg-card border-primary shadow-soft" : "bg-card/60 border-border"
            }`}
          >
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${selected ? "bg-gradient-primary text-primary-foreground" : "bg-secondary text-primary"}`}>
              <Icon size={18} />
            </div>
